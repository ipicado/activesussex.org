...
<head>
<meta charset="utf-8" />
<title>Active Sussex - Contacts grid template</title>
	...
	<div class="container">
		<div id="header">
			...
			<div id="slug">
				...
				<ul class="nav slugNav">
					...
					<li class="active"><a href="contacts-gallery.php">Contact us</a></li>   			
					<li><a href="#">Jobs</a></li>   			
				</ul>
			</div>
		</div>
		...
		<div id="content">
			<div class="sidebar column colx1">
				<h2>Contact us</h2>
				<ul class="nav subNav">
					<li><a href="page.php">How to contact us</a></li>
					<li class="active">Active Sussex team</li>
					<li class="highlight"><a href="#">Sussex 2012</a></li>
				</ul>
			</div>
			<div class="contact_profile_page">
				<div class="mainContent column colx3">
					<h1>Active Sussex team</h1>
	
					<h2>Contact Name</h2>
					<h3>Position</h3>
					<p>Andy Duck joined Active Sussex in July 2010. Previously, Andy spent 15 years as a journalist, working for Esquire, Time magazine, The Face, The Guardian, Coast and Grand Designs Magazine.</p>
					<p>He also spent two years working for contract publishers August Media, where he managed and developed online and social media content for www.ikeafamilylive.com. At Active Sussex he is responsible for all external communications.</p>
					<p>His main areas of work are:</p>
					<ul>
					<li>website development</li>
					<li>social network content and strategy</li>
					<li>emarketing</li>
					<li>print and marketing materials</li>
					<li>press liaison</li>
					</ul>
					<p>He writes Active Sussex’s monthly enews bulletin and additional online content.</p>
	
				</div>
				<div class="sidebar column colx1 last">
					<div class="profile_pic"><img src="images/placeholder.gif" width="100%" height="100%"/></div>
					<ul class="contact_methods">
						<li class="phone">01273 644139</li>
						<li class="email"><a href="#">Send an email</a></li>
					</ul>
				</div>
			</div>
		</div>
