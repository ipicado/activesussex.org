...
<div id="wrap">
	<div class="container">
		...
		<div id="content">
			<div class="sidebar column colx1">
				<h2>About us</h2>
				<ul class="nav subNav">
					...
					<li><a href="contacts-gallery.php">Contact us</a></li>
					<li class="highlight"><a href="#">Sussex 2012</a></li>
				</ul>
			</div>
			<div class="mainContent column colx3">
				<h1>What we do</h1>
				<div class="primary_image">
					<img src="images/placeholder.gif" width="100%" height="200"/>
				</div>
				<h2>Heading 2</h2>
				<h3>Heading 3</h3>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec quis magna at mauris sodales dignissim. In orci dolor, placerat quis, vulputate non, tempor tincidunt, lacus. Sed imperdiet, nisi id molestie lobortis, enim lorem molestie est, at suscipit velit nisl eu nulla. Donec consectetuer orci id ante. Nullam consectetuer, dolor in lobortis molestie, mauris dolor commodo orci, quis consectetuer tortor sem ac nibh. Vivamus ante. Suspendisse accumsan mi ac lorem. Vestibulum sem purus, adipiscing id, sollicitudin vel, ullamcorper et, mauris. Nunc libero diam, faucibus eget, sagittis cursus, fermentum at, turpis. Vestibulum varius nunc. Pellentesque vitae neque. Nulla facilisi. Phasellus quis mi id erat dictum venenatis.</p>
				<h3>Heading 3</h3>
				<p>Quisque pellentesque volutpat elit. Sed ut ipsum. Duis a erat. Suspendisse luctus mauris at sem. Donec vehicula ultricies augue. Donec lectus quam, viverra a, posuere at, commodo vitae, velit. Ut enim. Suspendisse vulputate vestibulum magna. Phasellus magna nulla, ultricies ut, condimentum at, porttitor in, mauris. Proin euismod nunc quis pede. Curabitur scelerisque, dolor quis malesuada dignissim, arcu lorem malesuada urna, a vulputate tortor elit nec ipsum. Curabitur tempor augue a sapien. Nam enim. Integer varius elit non felis.
</p>
			</div>
			<div class="sidebar column colx1 last">
				
				<h2>Related pages</h2>
				<ul class="nav linksNav">
				...
				<ul class="nav docsNav">
					<li class="pdf"><a href="#">Uploaded file</a>(PDF 200k)</li>
					<li class="pdf"><a href="#">Uploaded file</a>(PDF 200k)</li>
					<li class="pdf"><a href="#">Uploaded file</a>(PDF 200k)</li>
				</ul>
				
				<h2>On other websites</h2>
				<ul class="nav linksNav">
					<li><a href="#">Linked item</a></li>
					<li><a href="#">Linked item</a></li>    
					<li><a href="#">Linked item</a></li>    
				...
				<div class="sidebar_item">
					<p class="comment">Comment on this page</p>
					<img src="images/placeholders/tweet-share.jpg" alt="tweet-share" width="117" height="20" />
				</div>
			</div>
		</div>
		<div id="footer">
